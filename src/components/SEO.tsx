 ...
 * Represents a single metadata item
 */
interface MetadataPropertyItem {
  /**
   * Property of the metadata tag
   */
  property: string
  /**
   * Contents of the metadata tag
...
interface SEOInput {
  ...
  description?: string
  /**
   * Absolute URL for the featured image of the page.
   */
  imageURL?: string
  /**
   ...
   */
  meta?: (MetadataItem | MetadataPropertyItem)[]
  /**
   * Title of the page.
   */
  title: string
